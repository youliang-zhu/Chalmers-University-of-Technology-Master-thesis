...
3. For W0/W4, write or revise the current paper artifact; for W5, mark unresolved issues and
   ...
   For W0, do not rely on stale target-file scaffold content, future section drafts, old
   conference-paper prose, old paper-agent notes, or history-paper summaries. Use NanoMem
   code/experiment artifacts and already accepted thesis plans/artifacts only.
